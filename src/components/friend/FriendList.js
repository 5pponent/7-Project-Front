...
export default function FriendList(props) {
    ...
    return ( 
        <List sx={{width:700, height: '79vh', overflow: 'auto', border: '1px solid #e0e0e0'}} >
            ...
            <FriendProfile name='Alice' image="https://material-ui.com/static/images/avatar/2.jpg" />
            <FriendProfile name='Cindy Baker' image="https://material-ui.com/static/images/avatar/3.jpg" />
            <FriendProfile name='Cordelai Lottie Michelle Owen' image="https://material-ui.com/static/images/avatar/4.jpg" />
        </List>
    );
}
